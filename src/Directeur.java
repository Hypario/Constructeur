...
public class Directeur {
    ...
    private void handleLine(String line) {
        if (line.contains("**")) {
            ...
            constructeur.buildRawText(result[0]);
            constructeur.buildBold(result[1]);
            handleLine(result[2]);
            ...
            constructeur.buildRawText(result[0]);
            constructeur.buildItalic(result[1]);
            handleLine(result[2]);
        } else {
    ...
    private String[] split(String regex, String line) {
        Pattern pattern = Pattern.compile(regex);
        return pattern.split(line, 3);
    }
}
